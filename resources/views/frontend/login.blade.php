        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form method="POST" action="{{ route('check_login') }}" class="md-float-material form-material">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center">تسجيل دخول المستخدمين</h3>
                                    </div>
                                </div>
...
{{--                                    <span class="form-bar"></span>--}}
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="{{ route('register') }}"><b class="f-w-600">{{ __('Register ?') }}</b></a></p>
                                        @endif
